...
% OUTPUT:
%     myCentroid: x,y,z cordinate of centroid
%          myCentroid(1,1): x coordinate
%          myCentroid(1,2): y coordinate
%          myCentroid(1,3): z coordinate
% 
% AUTHOR:
...
%   Year: 2016
function [myCentroid,varargout] = centroidOfPolyhedron(vertex,faces)
    ...
    myCentroid = sum(mg2)./totArea;
    
    if nargout > 1
        varargout{1} = centroidTriangles;
    end
